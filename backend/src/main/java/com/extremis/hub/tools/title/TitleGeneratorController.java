...
public class TitleGeneratorController {
    ...
    public TitleGeneratorResponse generate(@Valid @RequestBody TitleGeneratorRequest request, Authentication authentication) {
        ...
        TitleGeneratorResponse response = titleGeneratorService.generate(request, useAi, userId);
    ...
    /**
     * Phase 29: "make it punchier" on an AI-generated result. No
     ...
     */
    @PostMapping("/refine")
    public TitleGeneratorResponse refine(@Valid @RequestBody RefineRequest request, Authentication authentication) {
